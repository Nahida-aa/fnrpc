...
use crate::handler::{
    ErasedHandler, ErasedSubscribeHandler, RawRpcFn, RoutedHandler, RoutedSubscribeHandler, RpcFn,
};
use crate::middleware::{ClosureService, ErasedRpcService, RpcLayer, RpcService};
...
impl<Ctx: Send + Sync + 'static> ErasedHandler<Ctx> for RawRpcAdapter<Ctx> {
    ...
    fn populate_types(
        &self,
        _types: &mut specta::Types,
        _top_level: &mut Vec<specta::datatype::DataType>,
    ) {
    }
